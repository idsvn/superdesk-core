...
from superdesk.io.feed_parsers.belga.belga_newsml_1_2 import BelgaNewsMLOneFeedParser
...
class AFPBelgaNewsMLTestCase(BaseBelgaNewsMLParserTestCase):
    ...
    def test_content(self):
        ...
        self.assertEqual(item["word_count"], "270")
        ...
        self.assertEqual(item["provide_id"], "AFP", )
